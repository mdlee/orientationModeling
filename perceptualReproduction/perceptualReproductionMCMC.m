%% Perceptual reproduction MCMC (wrap-copy Gaussian, automated)
%
% Same generative model as perceptualReproduction, with the shareable
% sampler: 8 chains kept in full, data-informed inits, no nu/yP monitors,
% wrap alignment, split-Rhat / ESS gates, 10k joint draws.
%
% Storage: storage/perceptualReproductionMCMC_tomicBays_jags.mat
% (does not overwrite perceptualReproduction_tomicBays_jags.mat)
...
modelDir = './';
modelName = 'perceptualReproductionMCMC';
engine = 'jags';
...
for dataIdx = 1:numel(dataList)
   ...
   if ~diagnostics.converged
      warning('perceptualReproductionMCMC:diagnostics', ...
